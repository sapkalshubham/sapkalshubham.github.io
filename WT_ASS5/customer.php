...
class customer{
    ...
    public function insertcustomerdetail($obj){
        $sql="INSERT INTO participants (fname,lname,email,gender,city,mobile,booking_time) VALUES('$obj->fname','$obj->lname','$obj->email','$obj->gender','$obj->city','$obj->mobile','$obj->booking_time');";
